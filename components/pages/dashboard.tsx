...
import { DropdownMenuCheckboxes } from "../ui/dropdown-menu-button";
...
export function Dashboard() {
    ...
    return (
        <div className="antialiased bg-gray-50 dark:bg-gray-900 flex flex-row items-center justify-start">
            {/* Sidebar */}
            <aside
                className={`z-40 h-screen overflow-x-hidden  transition-transform -translate-x-full bg-white  border-[#CDD7E1] md:translate-x-0 dark:bg-gray-800 border-r dark:border-gray-700 ${menuItemHidden ? "w-24" : "w-fit"
                    }`}
                aria-label="Sidenav"
                ref={asideRef}
                ...
                <header className="flex justify-between items-center p-4 h-fit">
                    ...
                    <div className="flex">
                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15 18.5L9 12.5L15 6.5" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                        <p className="w-fit">
                            Login Information of EMP
                        </p>
                    </div>
                    <motion.div
                        ...
                        <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4.5 7.25L9 11.75L13.5 7.25" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                        ...
                        <AnimatePresence>
                            ...
                            <motion.div
                                className={`${dropDownMenu ? "absolute top-12 right-1 bg-white" : "hidden"} border-[1px] border-solid border-[#D1D5DB] rounded-lg`}>
                                ...
                                <div className="flex flex-col px-1 p-1">
                                    ...
                                    <p className="hover:bg-[#D1D5DB] px-1 rounded"> PostgreSQL </p>
